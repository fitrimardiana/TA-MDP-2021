...
class _DetailVideoState extends State<DetailVideo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            Text('Recipe Videos', style: TextStyle(fontWeight: FontWeight.bold)),
            SizedBox(width: 10),
  ...
  Widget buildVideo() => Stack(
    children: <Widget>[buildVideoPlayer(), Positioned.fill(child:
    buildBasicOverlay())],
  );
  ...
  Widget buildBasicOverlay() => GestureDetector(
    ...
    onTap: () => playerController.value.isPlaying ? playerController.pause :
  ...
  Widget buildIndicator() => VideoProgressIndicator(playerController,
  allowScrubbing: true);
